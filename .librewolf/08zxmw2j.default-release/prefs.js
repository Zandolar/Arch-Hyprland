...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1708453375);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1708468818);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1682697486);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1708453375);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1708453375);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1708455969235");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1708477569235");
...
user_pref("browser.startup.lastColdStartupCheck", 1708462535);
...
user_pref("dom.push.userAgentID", "cb41703ed6db4c25900d757fec3cde33");
user_pref("dom.security.https_only_mode_ever_enabled", true);
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 35);
user_pref("extensions.getAddons.cache.lastUpdate", 1708455969);
...
user_pref("idle.lastDailyNotification", 1708453719);
user_pref("intl.accept_languages", "en-US, en");
user_pref("javascript.use_us_english_locale", true);
user_pref("media.eme.enabled", true);
user_pref("media.gmp-manager.buildID", "20240214130749");
user_pref("media.gmp-manager.lastCheck", 1708455968);
user_pref("media.gmp-manager.lastEmptyCheck", 1708455968);
...
user_pref("places.database.lastMaintenance", 1708345759);
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1707696005);
user_pref("storage.vacuum.last.index", 1);
user_pref("storage.vacuum.last.places.sqlite", 1707782419);
