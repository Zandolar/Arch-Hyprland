#!/bin/bash
PACMAN_APPS="ark bluez blueman brightnessctl chromium discord cargo cifs-utils dolphin dunst ffmpegthumbs firefox flatpak font-manager fuse2 gimp gtk2 gtk3 gtk4 kdelibs4support kio kdialog kitty kvantum libwnck3 micro neofetch networkmanager nmap otf-font-awesome packagekit-qt5 plasma-framework plasma-workspace powerline-fonts qt5ct rust samba vlc xdg-desktop-portal"
...
sudo pacman -Sy $PACMAN_APPS --noconfirm

git clone https://aur.archlinux.org/paru.git
cd paru
makepkg -si

paru -Sy $PARU_APPS --noconfirm --sudoloop
